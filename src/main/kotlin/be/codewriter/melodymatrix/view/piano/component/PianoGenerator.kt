...
import be.codewriter.melodymatrix.app.data.BackgroundImage
import be.codewriter.melodymatrix.app.data.Note
import be.codewriter.melodymatrix.app.data.PianoSettingsEffect
...
class PianoGenerator(
    ...
    override fun initGameVars(vars: MutableMap<String, Any>) {
        ...
        vars.put(PianoProperty.BACKGROUND_IMAGE.name, BackgroundImage.NONE)
    ...
    class GameFactory : EntityFactory {
        ...
        fun spawnBackgroundImage(data: SpawnData): Entity {
            ...
            (getop<ObjectProperty<*>>(PianoProperty.BACKGROUND_IMAGE.name) as ObjectProperty<BackgroundImage>).addListener { _, _, newValue ->
                if (newValue == BackgroundImage.NONE) {
