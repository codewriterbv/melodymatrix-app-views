...
enum class MainNote(
    ...
    C(1, "C", PianoKeyType.RIGHT, Color.web("#0197DE"), Color.BLACK, "Do"),
    C_SHARP(2, "C#", PianoKeyType.SHARP, Color.web("#0197DE"), Color.BLACK),
    D(3, "D", PianoKeyType.BOTH, Color.web("#0197DE"), Color.BLACK, "Re"),
    D_SHARP(4, "D#", PianoKeyType.SHARP, Color.web("#0197DE"), Color.BLACK),
    E(5, "E", PianoKeyType.LEFT, Color.web("#62BD4A"), Color.BLACK, "Mi"),
    F(6, "F", PianoKeyType.RIGHT, Color.web("#A1D490"), Color.BLACK, "Fa"),
    F_SHARP(7, "F#", PianoKeyType.SHARP, Color.web("#C5E3B9"), Color.BLACK),
    G(8, "G", PianoKeyType.BOTH, Color.web("#EFE3BC"), Color.BLACK, "Sol"),
    G_SHARP(9, "G#", PianoKeyType.SHARP, Color.web("#FFD824"), Color.BLACK),
    A(10, "A", PianoKeyType.BOTH, Color.web("#FCA300"), Color.BLACK, "La"),
    A_SHARP(11, "A#", PianoKeyType.SHARP, Color.web("#F3522C"), Color.BLACK),
    B(12, "B", PianoKeyType.LEFT, Color.web("#D04625"), Color.BLACK, "Si"),
