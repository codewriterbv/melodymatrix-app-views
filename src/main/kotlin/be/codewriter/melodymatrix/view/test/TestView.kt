...
import be.codewriter.melodymatrix.view.stage.chord.ChordRelationStage
import be.codewriter.melodymatrix.view.stage.chord.ChordStage
import be.codewriter.melodymatrix.view.stage.guitar.GuitarChordStage
 ...
 * - A **visualizer tab area** where each active [ViewStage] is embedded as a scaled tab
...
class TestView : VBox() {
     ...
     * @property stageSupplier Factory lambda that creates a new [ViewStage] instance
     */
    private data class StageOption(
        val label: String,
        val id: String,
        val stageSupplier: () -> ViewStage
    )

    /**
     * Holds the runtime state of an open visualizer tab.
     *
     * @property stage        The active [ViewStage] instance
